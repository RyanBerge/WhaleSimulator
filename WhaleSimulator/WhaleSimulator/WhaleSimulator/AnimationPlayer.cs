...
namespace WhaleSimulator
{
    ...
    public class AnimationPlayer
    {
        ...
        /// </summary>
        //[Browsable(false)]
        public Graphics3D Model { get { return model; } }
        ...
        public AnimationPlayer(AnimationClip clip, Graphics3D model)
        {
            this.clip = clip;
            this.model = model;
        ...
        private class BoneInfo
        {
            ...
            public void SetModel(Graphics3D model)
            {
                // Find this bone
